 ...
 * @author Ilham Izzul
 */
public class Bankawal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        saldo.setBounds(500, 170, 103, 32);
        ...
        penarikan.setBounds(80, 170, 103, 32);
        ...
        transfer.setBounds(80, 230, 103, 32);
        ...
        logOut.setBounds(500, 290, 100, 30);
        getContentPane().add(inputPenarikan);
        inputPenarikan.setBounds(210, 170, 200, 30);
        getContentPane().add(inputTransfer);
        inputTransfer.setBounds(210, 230, 200, 30);
        getContentPane().add(inputSetor);
        inputSetor.setBounds(210, 290, 200, 30);

        keterangan.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        getContentPane().add(keterangan);
        keterangan.setBounds(170, 350, 320, 30);
        ...
        jLabel3.setBounds(330, 20, 41, 22);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 255, 255));
        jLabel1.setText("BNI SYARIAH-BOJONEGORO");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(230, 60, 253, 22);

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 255, 255));
        jLabel6.setText("Silahkan Memilih Menu Yang Tersedia");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(200, 100, 303, 22);

        jPanel1.setBackground(new java.awt.Color(0, 51, 204));
        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, 0, 700, 420);

        setBounds(0, 0, 717, 460);
    ...
    private void saldoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saldoActionPerformed
        ...
        int saldo = 150000;
        keterangan.setText("SISA SALDO ANDA SEKARANG");
        nilai.setText(""+saldo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bankawal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
